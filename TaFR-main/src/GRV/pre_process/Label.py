...
class Label:
    ...
    def prepareDied(self,args,corpus):
        ...
        risk_rank = hourInfo.groupby(['timelevel']).apply(getRank).reset_index(level=0, drop=True)
        hourInfo['riskRank'] = risk_rank
        ...
        print(os.getcwd())
        item.to_csv(r'C:\DS\repos\TaFR\src\GRV\label\kwai__1__24__168__0.5__0.5__-3.0.csv',index=False)
